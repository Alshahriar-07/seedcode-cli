...
version (currently **7.1.0**) from the GitHub release, verifies its SHA256
...
The version is not duplicated here: the launcher reads it from
`package.json`, which mirrors `seedcode.__version__` (the canonical version
